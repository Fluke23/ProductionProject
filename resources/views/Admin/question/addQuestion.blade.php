    ...
    <form action="{{URL::to('question/saveQuestion')}}" method="post">
      ...
      {{-- Quizs_id--}}
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="questions_types_id" type="text" class="form-control{{ $errors->has('questions_types_id') ? ' is-invalid' : '' }}" name="questions_types_id" value="{{ old('questions_types_id') }}" required autofocus>
