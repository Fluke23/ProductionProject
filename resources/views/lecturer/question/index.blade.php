...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{URL::to('/Admin/quiz/quizDetail/'.$subject_id)}}">Quiz Manager</a></li>

            <li class="breadcrumb-item"><a href="{{URL::to('/Lecturer/question/'.$quizs_id)}}">Question Manager</a></li>
